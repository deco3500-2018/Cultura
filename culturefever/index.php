...
<section class="illustration" id="page-top">

    <form name="advance_filter" id="advance_filter" >
    <div class="ui fluid multiple search selection dropdown dd">
...
<button class="ui fluid secondary button dd submit_filter">
  LET'S GO!
</button>
</form>
   ...
   <div class="container">
        <div class="row">
             <div class="col-lg-6 col-lg-offset-3 text-center" id="introtext" >
                  <p>Explore how other cultures use body gestures</p>
            </div>
      </div>
      ...
      $query = mysqli_query($link,"select * from practices, user where practices.userID=user.userID ORDER BY RAND() limit 14");
