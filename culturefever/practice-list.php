  ...
  if (isset($_GET['pracName'])) {
  	// Connect to the MySQL database  
  	require_once('mysql_connect.php');


  	$pracName = str_replace("+", " ", $_GET["pracName"]);
    //preg_replace('#[^0-9]#i', '', $_GET['pracName']); 
  	
    $query = "SELECT * FROM practices, types WHERE pracName='$pracName'";
...
$query = mysqli_query($link,"select * from practices, user where practices.userID=user.userID AND practices.pracName='$pracName' ORDER BY RAND() limit 6");
...
if ($count==0) {
    ...
    <div class="row">
      <div class="col-lg-6 col-lg-offset-3 text-center" id="introtext" style="color: #000;">
        <p><?php echo $pracName; ?>There isn't anything posted yet about <b style="font-size: 18px; color: darkseagreen;"><?php echo $row['typeName'] ?></b>. Add one if you know something!</p>
    </div>
</div>
</br>
<div class="row">
...
<div class="row">
 <div class="col-lg-10 col-lg-offset-1">
    ...
    <input type="hidden" name="type" value="<?php echo $pracName; ?>">
