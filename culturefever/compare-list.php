...
$query = mysqli_query($link,"select * from practices, user where practices.userID=user.userID AND pracCountry='Australia'");
$query1 = mysqli_query($link,"select * from practices, user where practices.userID=user.userID AND pracCountry='Malaysia'");

if (isset($_POST['btn-submit'])) {

  $country1 = mysqli_real_escape_string($link,$_POST['country1']);
    $country2 = mysqli_real_escape_string($link,$_POST['country2']);
  ...
  $query = mysqli_query($link,"select * from practices, user where practices.userID=user.userID AND categoryID='$category1' AND pracCountry='$country1' AND typeID='$cat2'");

  $query1 = mysqli_query($link,"select * from practices, user where practices.userID=user.userID AND categoryID='$category1' AND pracCountry='$country2' AND typeID='$cat2'");
}


?>
<!-- About Section -->
<section class="compare" id="about">
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-6 col-lg-offset-3 text-center" id="introtext">
        <p>Compare culture between two countries</p>
      </div>
    </br>
    </br>
    <br>
    <form  class="form-horizontal sign-in" method="POST" action="compare-list.php">
    <div class="col-lg-10 col-lg-offset-1">
    <select class="ui fluid selection dropdown dd" name="category1" id="category1">
      <i class="dropdown icon"></i>
      <option value="">What do you wish to know?</option>
      <option value="1"  >Gestures</option>
      <option value="2" >Etiquettes</option>
    </select>
  ...
  <div class="col-lg-10 col-lg-offset-1">
    <table class="ui very basic collapsing celled table">
      <thead>
        ...
        <tbody>
          <tr>
            <td class="center aligned" colspan="2"><button type="SUBMIT" name="btn-submit" style="width: 50%; font-size: 16px;" class="ui green button">
  See Result
</button></form></td>
          </tr>
          <tr>
            <td>
                ...
                if ($count==0) {
                  echo '<div class="ui card card-out no-result">
                    <div class="content card-inside">No result found.</div></div>';
                }
                  ...
                  <div class="ui card card-out desc-home compare">
                    <div class="content card-inside">
                      ...
                      <div class="description desc-small">
                        ...
                        <div class="addedby"><p>By <a><b style="text-transform: capitalize;"><?php echo $row["username"];?></b></a></p></div>
